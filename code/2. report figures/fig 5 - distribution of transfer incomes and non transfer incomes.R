# 4 distribution of transfer incomes and non transfer incomes 
# all counties, 2022
...
plot %>% 
  ...
  theme_minimal() +
  labs(fill="", 
       title = "Figure 5: Distribution of Transfer Incomes and Non-Transfer Incomes \n(all counties, 2022)", x = "dollars (thousands per capita)",y= "number of counties",
  ...
  theme(plot.title = element_text(color = "#1a654d", face="bold", size = 18),
    legend.position = "top",
    legend.text = element_text(size = 10),
    axis.text.x = element_text(size = 10),
        axis.text.y = element_text(colour = c('black','black','black','red', 'red'), size = 10))
...
density_plot = plot %>% 
  ...
  theme_minimal() +
  labs(fill="", 
       title = "Distribution of Transfer Incomes and Non-Transfer Incomes (all counties, 2022)", 
