...
The Bureau of Economic Analysis’s (BEA) [regional economic account files](https://apps.bea.gov/regional/downloadzip.htm) are the primary source of data for this report. These files cover a range of local socioeconomic data topics including local Gross Domestic Product, Personal Income, and Personal Consumption Expenditures for a range of locality sizes. The codebook is available under data/SPI-Methodology.pdf. We use two files for our county-level and national-level analysis:
